                    ...
                    <Grid item xs={12} sm={6} md={4} key={quiz.id} sx={{display: 'flex'}}>
                        <Card sx={{
                            ...
                            <CardActions sx={{justifyContent: 'space-between', mt: 'auto'}}>
                                ...
                                <Button variant="contained" color="primary" size="small"
                                        onClick={() => navigate(`/quizzes/edit/${quiz.id}`)} disabled={quiz.creator?.id === 1 && user.id !== 1}>Bearbeiten</Button>
                                <Button variant="contained" size="small" color="error"
                                        onClick={() => confirmDelete(quiz.id)} disabled={quiz.creator?.id === 1 && user.id !== 1}>Löschen</Button>
                            </CardActions>
                        </Card>
                    </Grid>
                ))}
